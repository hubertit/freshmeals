...
class _CalorieTrackerPageState extends ConsumerState<CalorieTrackerPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (user!.user != null) {
        ...
        await ref
            .read(progressTrackerProvider.notifier)
            .fetchProgressData(context, user.user!.token);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    var progressState = ref.watch(progressTrackerProvider);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                color: Colors.white,
                height: 300,
                padding: const EdgeInsets.only(top: 10, right: 10, bottom: 6),
                child: calorisState.isLoading
                    ? const Center(
                        child: CircularProgressIndicator(),
                      )
                    : calorisState.calorieData?.dailyEntries == null ||
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text('${formatMoney(entry.calories)} Cal'),
                            trailing: Text(
                              '(${entry.percentage}%)',
                              style: TextStyle(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onHorizontalDragUpdate: (details) {
                                        setModalState(() {
                                          if (details.delta.dx > 0 &&
                                              _abdomenCircumference < 120) {
                                            _abdomenCircumference++;
                                          } else if (details.delta.dx < 0 &&
                                              _abdomenCircumference > 1) {
                                            _abdomenCircumference--;
                                          }
                                        });
                                      },
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(width: 20),
                                          Text(
                                            _abdomenCircumference.toString(),
                                            style: const TextStyle(
                                              fontSize: 40,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.black,
              ...
              SizedBox(
                ...
                child: progressState.isLoading
                    ...
                    : buildMonthlyBarChart(
                        entries: progressState.circumferenceEntries,
