...
import 'package:freshmeals/riverpod/notifiers/home/tracker_notifier.dart';
...
final progressTrackerProvider = StateNotifierProvider<ProgressTrackerNotifier, ProgressTrackerState>(
      (ref) => ProgressTrackerNotifier(),
);
